...
wp_enqueue_script( 'android-showcase', get_template_directory_uri() . '/js/showcase.js', array( 'jquery' ), '2011-04-28' );
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
					...
					<section class="featured-post <?php echo $feature_class; ?>" id="featured-post-<?php echo $counter_slider; ?>">
						...
						<?php
							...
							if ( has_post_thumbnail() ) {
								...
								?>
								<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'android' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_post_thumbnail( $thumbnail_size ); ?></a>
								<?php
							}
						?>
				...
				<section class="recent-posts">
					<h1 class="showcase-heading"><?php _e( 'Recent Posts', 'android' ); ?></h1>
					...
					while ( $recent->have_posts() ) : $recent->the_post(); ?>
						...
						<li class="entry-title">
							<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'android' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
							<span class="comments-link">
								<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply', 'android' ) . '</span>', __( '<b>1</b> Reply', 'android' ), __( '<b>%</b> Replies', 'android' ) ); ?>
							</span>
						</li>
